...
from functions import cat_curve_opt
...
from functions import analyse_maint_opt
from functions import open_csv
from functions import *
import xlrd 
from functions import analyse_optram_spl
from functions import open_iore_v2
...
IORE_filename = 'DataLok9174000012721.xlsx'
...
#val_rpm = np.zeros(7,dtype=object)
#for i in range(0,7):
...
data = np.load('iore_data_v2.npz',allow_pickle=True)
val_iore = data['a']
label_iore = data['b']
...
O_func = analyse_optram_spl(val_o,R_func_0,R_func_1,R_func_2,R_func_3,R_lim,R_coord,val_iore)
...
nr_cat_100,L_cat_100,cat_ryear_100,cat_veq_100,cat_prof_100,cat_maint_100,cat_gauge_100 = cat_curve_opt(O_func,maint,R_cat_100)

R_cat_3 = [600,3000]
nr_cat_3,L_cat_3,cat_ryear_3,cat_veq_3,cat_prof_3,cat_maint_3,cat_gauge_3 = cat_curve_opt(O_func,maint,R_cat_3)
