...
from functions import open_xls
from functions import analyse_curve
from functions import sort_tracks
from functions import cat_curve
from functions import open_iore
from functions import centre
from functions import sort_R_cat
from functions import analyse_maint
...
IORE_path = os.path.abspath(os.path.join(os.path.dirname(home),'DATA'))
...
O2_filename = ['RPM_1409121027A_111_E_1417_876_20210223_1105.csv','RPM_1409121027A_111_E_1417_876_20210223_1106.csv','RPM_1507270844A_111_E_1417_875_20210223_1105.csv',
                ...
                'RPM_1809231019A_111_E_1417_874_20210223_1109.csv','RPM_1909250857A_111_E_1417_875_20210223_1110.csv','RPM_2009240817A_111_IMV100M_20210223_1111.csv',
                'Rälslitage segment mätdata111.csv','SPL_1909250857A_111_E_1417_874_20210223_1107_gauge.csv','VIH_20200430_111_20210223_1103.csv',
                'VIH_20200501_111_20210223_1103.csv','VIV_20200430_111_20210223_1103.csv','VIV_20200501_111_20210223_1103.csv']
O2_columns = ['CORRIDOR_CODE','SURVEY_OFFSET','CORRIDOR_OFFSET','MARKER','MARKER_OFFSET','TRACK','Spårvidd (mm)']
S_filename = ['circle_section111_coordinates_v2.xlsx']
#S_columns = np.array([[0,1,2,3,5]])
S_columns = np.array([[15,16,17,18,1]])
IORE_filename = 'IORE127_Export_From_20201221_To_20201223.csv'
IORE_columns = ['DetectionTime','DetectionPoint (lat)','DetectionPoint (lon)','Active energy consumption IORE127','Active energy regeneration IORE127','Altitude IORE127','Distance IORE127']
...
val_o = open_csv(O2_path,O2_filename[10],O2_columns)

# IORE-data
val_iore = open_iore(IORE_path,IORE_filename,IORE_columns)
...
nr_cat_100,L_cat_100,cat_ryear_100,cat_veq_100,cat_prof_100,cat_maint_100,cat_gauge_100 = cat_curve(R_func_0,R_func_1,R_func_2,R_func_3,maint,gauge,R_cat_100)

R_cat_3 = [600,3000]
nr_cat_3,L_cat_3,cat_ryear_3,cat_veq_3,cat_prof_3,cat_maint_3,cat_gauge_3 = cat_curve(R_func_0,R_func_1,R_func_2,R_func_3,maint,gauge,R_cat_3)
...
cat_year_sort_100,cat_year_label_100,cat_veq_sort_100,cat_veq_label_100,cat_prof_sort_100,cat_prof_label_100,cat_maint_sort_100,cat_maint_label_100,cat_gauge_sort_100,cat_gauge_label_100=sort_R_cat(cat_ryear_100,cat_veq_100,cat_prof_100,cat_maint_100,cat_gauge_100,nr_cat_100)
...
plt.figure(1,figsize=(14,6)) #passage 1
ax = plt.axes()
ax.bar(R_cat_100, cat_prof_sort_100[:,0], width = 90,color = 'b', label = 'UIC')
ax.bar(R_cat_100, cat_prof_sort_100[:,1], bottom = cat_prof_sort_100[:,0],width = 90,color = 'r', label = 'E1')
